              ...
              <nav className='flex items-center justify-between flex-wrap'>
                <div className='w-full block flex-grow lg:flex lg:items-center lg:w-auto'>
                  ...
                  <div className='px-6'>
                    <a
                      href='#'
                      className='inline-block text-sm px-4 py-2 leading-none border rounded text-stone-50 border-lime-500 hover:border-transparent hover:text-stone-950 hover:text-xxl hover:bg-stone-50 mt-4 lg:mt-0'
                    >
                      Sign In
                    </a>
                  </div>
